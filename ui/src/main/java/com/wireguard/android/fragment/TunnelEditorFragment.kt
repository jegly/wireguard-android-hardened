...
class TunnelEditorFragment : BaseFragment(), MenuProvider {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Protect the entire editor screen — not just the moment the private key is revealed.
        // This prevents configs appearing in the recents thumbnail and blocks screenshots.
    ...
    private fun showPrivateKey(edit: EditText) {
        // FLAG_SECURE already set in onViewCreated — no need to set it again here.
